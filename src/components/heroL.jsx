...
const heroL = ({ hidden, media, title, text, subTitle, text2, subTitle2 }) => {
      ...
      <section className="text-gray-600 body-font">
        <div className="mx-auto flex px-5 py-10 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center">
            <h1 className="title-font text-center font-georgia sm:text-4xl text-4xl mb-6 font-bold text-gray-900">
              {title}
            ...
            <div className="flex flex-row items-center text-xl">
              <div className="m-2">
                <GiFamilyHouse color="#9BD052" className="size-14" />
              </div>
            ...
            <div className="flex flex-row items-center text-xl">
              <div className="m-2">
                <GiWorld color="#9BD052" className="size-14" />
              </div>
